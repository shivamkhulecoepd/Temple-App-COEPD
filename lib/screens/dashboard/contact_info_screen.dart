...
Map<String, dynamic> contactInfo = {}; // Will be populated from API
...
class _ContactScreenState extends State<ContactScreen> {
  ...
  Future<void> _loadContactData() async {
    try {
      final data = await DBFunctions().fetchContactInfo();
      if (mounted) {
        setState(() {
          contactInfo = data;
          _isLoading = false;
        ...
        // Initialize map controller with loaded data
      ...
      if (mounted) {
        setState(() {
          contactInfo = {
            ...
            "map_embed":
                "<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3805.465338810557!2d78.49195257383163!3d17.485286299980125!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb9a93ed4c27cf%3A0x841315cfc51aa611!2sMarakatha%20Sri%20Lakshmi%20Ganapathi%20Temple!5e0!3m2!1sen!2sin!4v1766726802785!5m2!1sen!2sin\" width=\"100%\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>",
            "updated_at": "2025-12-27 11:50:29",
          };
          _isLoading = false;
        });

        // Initialize map controller with fallback data
        _mapController = WebViewController()
          ..setJavaScriptMode(JavaScriptMode.unrestricted)
          ..loadHtmlString(_getCleanMapHtml(contactInfo['map_embed']));
      }
  ...
  Future<void> _submitForm() async {
    ...
    try {
      final result = await DBFunctions().submitContactForm(
